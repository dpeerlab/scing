...
task BasicQC {
    ...
    String dockerImage = dockerRegistry + "/sharp-basic-qc:0.2.2"
    ...
    command <<<
        ...
        # added cache directories that are writable in the container
        export NUMBA_CACHE_DIR=$HOME/.cache/numba
        export BLACK_CACHE_DIR=$HOME/.cache/black/21.7b0
        export XDG_CACHE_HOME=$HOME/.cache
        mkdir -p $NUMBA_CACHE_DIR $BLACK_CACHE_DIR $XDG_CACHE_HOME
